...
from client_panel.views import BookingCreateView, SignUpCreateView
...
registration_patterns = ([
                             ...
                             path('sign_up/', SignUpCreateView.as_view(success_url=reverse_lazy('registration:login')), name='sign_up')
                         ], 'registration')

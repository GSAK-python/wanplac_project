...
class Booking(models.Model):
    ...
    date = models.CharField(max_length=32, default=DateList.objects.values_list('date', flat=True)[0])  # (max_length=32, default=DateList.objects.values_list('date', flat=True)[0])
